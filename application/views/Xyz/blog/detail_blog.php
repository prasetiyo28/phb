...
<div id="content">
  <section>
    <div class="section-header">
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url('Xyz/blog/') ?>">Blog</a></li>
    ...
    <div class="section-body contain-lg">
                ...
                <div class="card-body">
                  <div class="hidden-xs">
                    ...
                    <div class="stick-top-right">
                      <a href="<?php echo base_url('Xyz/edit_post/'.$blog->id_news) ?>" class="btn btn-icon-toggle" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="fa fa-pencil"></i></a><br/>
              ...
              <div class="col-md-3">
                <div class="card-body">
                  ...
                  <ul class="nav nav-pills nav-stacked nav-transparent">
                    <li><a href="<?php echo base_url('Xyz/blogtags/0') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('0') ?></span>Pertanian</a></li>
                    <li><a href="<?php echo base_url('Xyz/blogtags/1') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('1') ?></span>Pertanian</a></li>
                    <li><a href="<?php echo base_url('Xyz/blogtags/2') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('2') ?></span>Perikanan</a></li>
                    <li><a href="<?php echo base_url('Xyz/blogtags/3') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('3') ?></span>Peternakan</a></li>
                  </ul>
                </div><!--end .card-body -->
              </div><!--end .col -->
      ...
      <div class="row">
        <div class="col-md-9">
          ...
          <form class="form form-validate form-horizontal " novalidate="novalidate" role="form" action="<?php echo base_url('Xyz/send_kometar') ?>" method="post">
            <div class="form-group">
              ...
              <div class="col-md-10">
                ...
                <textarea name="isi" id="textarea1" class="form-control autosize" rows="1" placeholder="Leave a comment" required></textarea>
              </div>
            </div>
...
<script type="text/javascript">
  ...
  function aksi_hapus_komentar(id) {
    var data = new FormData();
      ...
      var url = "<?php echo base_url('Xyz/deleteKomentar/'); ?>";
  ...
  function aksi_hapus_post(id) {
    var data = new FormData();
      ...
      var url = "<?php echo base_url('Xyz/deletePost/'); ?>";
        ...
        success: function(data)
          {
            if (data=='1')
            {
              ...
              toastr.success('Berhasil menghapus data', '');
              setTimeout(function () {
                window.location.href="<?php echo base_url('Xyz/blog') ?>";
              }, 2000);
            }
            else if(data=='0')
            {
