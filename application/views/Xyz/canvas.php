...
function open_chat(id_user) {
  $.ajax(
    {
      type: "GET",
      url: "<?php echo base_url('Xyz/openSideChat/'); ?>"+id_user
    }
  ).done(function( data )
  {
    $('#open_chat').html(data);
