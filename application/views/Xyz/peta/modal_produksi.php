<div id="modal_add_produksi" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <form class="form form-validate" id="form_produksi" novalidate="novalidate" method="post" action="<?php echo base_url() ?>/Xyz/insert_produksi">
				<div class="card">
...
$(function() {
  ...
  $.ajax({
  url: "<?php echo base_url('Xyz/get_all_user_ajax') ?>",
  dataType: "json",
  success: function (data) {
    minLength: 2,
