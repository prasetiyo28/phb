<div id="content">
  <section>
                  ...
                  <form class="navbar-search" role="search" id="form_cari2" style="display:none;">
										<div class="form-group">
											<input type="text" class="form-control" id="value_cari2" placeholder="Cari Nama">
										</div>
										<button type="button" class="btn btn-icon-toggle ink-reaction" id="search2"><i class="fa fa-search"></i></button>
									</form>
								</div>
								<div class="tools">
                  ...
                  <a class="btn btn-floating-action btn-default-light" href="javascript:void(0)" data-toggle="modal" data-target="#modal_add_admin" id="btn_add_admin" style="display:none;"><i class="fa fa-plus"></i></a>
								</div>
							</div><!--end .card-head -->
							<!-- END SEARCH HEADER -->
              <div class="card-body">
              ...
              <!-- BEGIN SEARCH NAV -->
									<div class="col-sm-4 col-md-3 col-lg-2">
										<ul class="nav nav-pills nav-stacked">
											...
											<li id="user"><a href="javascript:void(0)" >Pengguna <small class="pull-right text-bold opacity-75"><?php echo total_user() ?></small></a></li>
											<li id="admin"><a href="javascript:void(0)">Admin <small class="pull-right text-bold opacity-75"><?php echo total_admin() ?></small></a></li>
...
<?php $this->load->view('Xyz/pengguna/modal_user'); ?>
<?php $this->load->view('Xyz/pengguna/modal_admin'); ?>
...
$(document).ready(function(){
    $('[name="id_prov"]').change(function (){
          var url = "<?php echo base_url('Xyz/ajax_kabupaten');?>/"+$(this).val();
...
$('#admin').removeClass();
  $.ajax(
    {
      type: "GET",
      url: "<?php echo base_url('Xyz/user'); ?>"
    }
  ).done(function( data )
  {
    sort= a;
...
$('#user').removeClass();
  $.ajax(
    {
      type: "GET",
      url: "<?php echo base_url('Xyz/admin'); ?>"
    }
  ).done(function( data )
  {
    sort= e;
