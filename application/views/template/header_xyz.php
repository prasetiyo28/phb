      ...
      <ul class="header-nav header-nav-profile">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animation-dock">
            ...
            <li><a href="<?php echo base_url('Xyz/myprofile/') ?>">Profil</a></li>
            <li><a href="<?php echo base_url('Xyz/blog/') ?>">Blog <?php if (ttl_blog_today()!=0): ?>
          ...
          <script type="text/javascript">
              ...
              $('#btn_canvas').click(function() {
                ...
                if (canvas==false) {
                  $.ajax(
                    {
                      type: "GET",
                      url: "<?php echo base_url('Xyz/get_canvas'); ?>",
                    }
                  ).done(function( data )
                  {
            ...
            function open_chatReal(id_user,room_id,level) {
              ...
              $.ajax(
                {
                  type: "GET",
                  url: "<?php echo base_url('Xyz/openSideChatReal/'); ?>"+id_user+"/"+room_id+"/"+level
                }
              ).done(function( data )
              {
                console.log(data);
            ...
            function viewchatReal(room_id) {
              $.ajax(
                {
                  type: "GET",
                  url: "<?php echo base_url('Xyz/readChatReal/'); ?>"+room_id
                }
              ).done(function( data )
              {
