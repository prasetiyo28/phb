                                 ...
                                 <tbody><tr>
                                   <td width="350" align="center" class="mobile" style="font-size:12px; line-height:24px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tbody><tr>
                                              <td width="330" align="center" style="font-family: Montserrat, Arial, sans-serif; font-size: 28px; line-height:40px; letter-spacing:2px; color: #333333; font-weight:400;" data-color="H1 Color" data-size="H1 Size" data-min="12" data-max="40" mc:edit=""><multiline label="content">Hai.. <?php echo $nama ?></multiline></td>
                                          </tr>
                                              <tr>
                                                <td height="20" style="font-size:10px; line-height:10px;"></td>
                                              </tr>
                                              <tr>
                                                <td height="20" align="center" style="font-family: Montserrat, Arial, sans-serif; font-size:16px; letter-spacing:1px; line-height:25px; color: #333333; font-weight:400"data-color="H4 Color" data-size="H4 Size" data-min="12" data-max="30" mc:edit=""><multiline label='content'>Berikut Password dan Username Kamu</multiline></td>
                                              </tr>
                                              <tr>
                                                <td height="20" style="font-size:10px; line-height:10px;"> </td><!-- Spacer -->
                                            </tr>
                                            <tr>
                                              <td align="center" style="font-family: OpenSans, Arial, sans-serif; font-size: 13px; color: #8D8D8D; line-height:23px; font-weight:400;" data-color="H6 Color" data-size="H6 Size" data-min="10" data-max="24" mc:edit=""><multiline label="content">Username : <?php echo $user ?><br> Password : <?php echo $pass ?> <br> Jangan sampai lupa lagi yaa.. ^_^</multiline></td>
                                          </tr>
                                        </tbody></table>
                                        <!-- End Content -->
                                   </td>
