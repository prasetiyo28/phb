 ...
 <!-- Start Background -->
    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#D2D7D3">
        <tr>
          ...
          <table width="100%" data-module="Notif2.1" data-thumb="thumbnails/Notif2.png" align="center" cellpadding="0" cellspacing="0" border="0" class="wrapper" bgcolor="#373737" data-bgcolor="MainBG_Color5">
                    <tbody>
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="border-radius:25px" class="container">
                                 <tbody>
                                   ...
                                   <tr>
                                     <td align="center" class="mobile" style="font-size:12px; line-height:24px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#0aa89e" data-bgcolor="BlueBoxBG_Color">
                                       <tbody><tr>
                                         <td height="40"></td>
                                       </tr>
                                         <tr>
                                           <td height="20" align="center"><img mc:edit="" editable="" src="<?php echo base_url('assets/img') ?>/logo.png" width="100" height="50"></td>
                                         </tr>
                                         <tr>
                                         <td height="20"></td>
                                       </tr>
                            ...
                            <table width="300" cellpadding="0" cellspacing="0" border="0" class="container">
                                ...
                                <tr>
                                    <td width="100" height="22" class="mobile50" align="center" style="font-family: OpenSans, Arial, sans-serif; font-size: 13px; text-decoration:none; color: #FFFFFF; line-height:23px; font-weight:400;" data-color="H8Linkwht Color" data-size="H8Linkwht Size" data-min="8" data-max="24">
                                      <a href="<?php echo base_url() ?>" target="_blank" alias="" style="font-family: OpenSans, Arial, sans-serif; font-size: 13px; text-decoration:none; color: #FFFFFF; line-height:23px; font-weight:400;" data-color="H8Linkwht Color" data-size="H8Linkwht Size" data-min="8" data-max="24" mc:edit=""><multiline>PEMETAAN HASIL BUMI</multiline></a></td>
                                </tr>
                            </tbody></table>
                            <!-- End Container -->
                    ...
                    <tr>
                        <td align="center">
                          ...
                          <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" class="container">
                                 <tbody>
                                   <tr>
                                     <td align="center" bgcolor="#0aa89e" style="font-size: 35px; line-height: 30px; color: #ffffff; font-weight: 700;"></td>
                                   </tr>
                                   <tr>
                                     <td height="50"></td>
                                   </tr>
                                 ...
                                 <tbody><tr>
                                   <td width="350" align="center" class="mobile" style="font-size:12px; line-height:24px;">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0" class="container">
                                            <tbody><tr>
                                              <td width="330" align="center" style="font-family: Montserrat, Arial, sans-serif; font-size: 28px; line-height:40px; letter-spacing:2px; color: #333333; font-weight:400;" data-color="H1 Color" data-size="H1 Size" data-min="12" data-max="40" mc:edit=""><multiline label="content">Hallo.. <?php echo $nama ?></multiline></td>
                                          </tr>
                                              <tr>
                                                <td height="20" style="font-size:10px; line-height:10px;"></td>
                                              </tr>
                                              <tr>
                                                <td height="20" align="center" style="font-family: Montserrat, Arial, sans-serif; font-size:16px; letter-spacing:1px; line-height:25px; color: #333333; font-weight:400"data-color="H4 Color" data-size="H4 Size" data-min="12" data-max="30" mc:edit=""><multiline label='content'>Akun Baru Kamu Sudah Siap!</multiline></td>
                                              </tr>
                                              <tr>
                                                <td height="20" style="font-size:10px; line-height:10px;"> </td><!-- Spacer -->
                                            </tr>
                                            <tr>
                                              <td align="center" style="font-family: OpenSans, Arial, sans-serif; font-size: 13px; color: #8D8D8D; line-height:23px; font-weight:400;" data-color="H6 Color" data-size="H6 Size" data-min="10" data-max="24" mc:edit=""><multiline label="content">Silahkan login dengan username <b><?php echo $user ?></b> dan password <b><?php echo $pass ?></b>. <br> Terimkasih.. ^_^ </multiline></td>
                                          </tr>
                                        </tbody></table>
                                        <!-- End Content -->
                                   </td>
                    ...
                    <tr>
                        <td align="center">
                          ...
                          <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="border-radius:25px" class="container">
                                 <tbody>
                                   <tr>
                                     <td align="center" bgcolor="#0aa89e" style=" border-top-left-radius:4px; border-top-right-radius:4px; font-size: 35px; line-height: 30px; color: #ffffff; font-weight: 700;"></td>
                                   </tr>
                                   <tr>
                                     <td align="center" class="mobile"><table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#0aa89e" data-bgcolor="FootBoxBG_Color" class="container">
                                <tbody><tr>
                                    <td width="350" align="center" class="mobile" style=" font-size:12px; line-height:24px;">
                                        <!-- Start Content -->
                                  ...
                                  <tr>
                                    <td align="center" class="mobile" style="font-family: OpenSans, Arial, sans-serif; font-size:12px; line-height:24px;">
                                        ...
                                        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="container">
                                          <tbody>
                                            <tr>
                                            <td align="center" height="20" class="mobile" style="font-family: OpenSans, Arial, sans-serif; font-size: 13px; color: #8D8D8D; line-height:23px; font-weight:400;" data-color="H7 Color" data-size="H7 Size" data-min="10" data-max="24" mc:edit=""><multiline>copyright © 2018 | <?php echo base_url() ?></multiline></td>
                                          </tr>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                                <tbody>
                                  <tr>
                                    <td width="400" align="center" class="mobile" style="font-family: OpenSans, Arial, sans-serif; font-size:12px; line-height:24px;">
                                        <!-- Start Content -->
