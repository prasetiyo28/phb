  ...
  <div id="offcanvas-demo-left1" class="offcanvas-pane width-9" style="z-index:1000;">
    ...
    <div class="offcanvas-body">
      ...
      <hr style="margin-top: 0px;">
        ...
        <h4 class="title">Detail Produksi
          <?php if ($a->panen_flag=='0'): ?>
            <span class="badge style-accent">Belum Panen</span>
          <?php elseif($a->panen_flag=='1'):  ?>
            <span class="badge style-success">Sudah Panen</span>
          <?php else: ?>
            <span class="badge style-danger">Gagal Panen</span>
          <?php endif; ?>
        ...
        <?php elseif($a->panen_flag=='1'):  ?>
          <table class="a table table-responsive table-banded">
            <tbody>
              ...
              <tr>
                <td>Tanggal Panen</td>
                <td><?php echo tgl_indo($a->tgl_panen) ?></td>
              </tr>
              <tr>
                <td>Jumlah Bibit</td>
                <td><?php echo $a->jml_bibit ?> kg/ekor</td>
              ...
              <tr>
                <td>Jumlah Panen</td>
                <td><?php echo $a->jml_panen ?> kg/ekor</td>
              </tr>
              <tr>
                <td>Harga Perkilo/ekor</td>
                <td><?php echo $a->harga_perkilo_panen ?></td>
              </tr>
              <tr>
                <td>Luas Lahan</td>
                <td><?php echo $a->luas ?> m<sup>2</sup></td>
