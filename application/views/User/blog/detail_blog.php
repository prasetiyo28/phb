    ...
    <div class="section-body contain-lg">
              ...
              <div class="col-md-3">
                <div class="card-body">
                  ...
                  <ul class="nav nav-pills nav-stacked nav-transparent">
                    <li><a href="<?php echo base_url('User/blogtags/0') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('0') ?></span>Pertanian</a></li>
                    <li><a href="<?php echo base_url('User/blogtags/1') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('1') ?></span>Pertanian</a></li>
                    <li><a href="<?php echo base_url('User/blogtags/2') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('2') ?></span>Perikanan</a></li>
                    <li><a href="<?php echo base_url('User/blogtags/3') ?>"><span class="badge pull-right"><?php echo ttl_blog_bybidang('3') ?></span>Peternakan</a></li>
                  </ul>
                </div><!--end .card-body -->
              </div><!--end .col -->
      ...
      <div class="row">
        <div class="col-md-9">
          ...
          <form class="form form-validate form-horizontal " novalidate="novalidate" role="form" action="<?php echo base_url('User/send_kometar') ?>" method="post">
...
<script type="text/javascript">
  ...
  function aksi_hapus_komentar(id) {
    var data = new FormData();
      ...
      var url = "<?php echo base_url('User/deleteKomentar/'); ?>";
