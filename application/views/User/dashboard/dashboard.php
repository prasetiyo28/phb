    ...
    <div class="section-body">
      <div class="row">
              ...
              <div class="col-md-9">
                <div class="card">
                  <div class="card-head">
                    <header>Histori Panen Tahun <?php echo date('Y') ?></header>
                    <div class="tools">
                      ...
                      <div class="col-sm-6 hidden-xs">
                        <div class="force-padding text-sm text-default-light">
                          <p>
                            ...
                            Info grafis panen produksi tahun <?php echo date('Y') ?>.
                          </p>
                        </div>
                      </div><!--end .col -->
                    </div><!--end .row -->
                    <div class="stick-bottom-left-right force-padding">
                      <div id="myChart" class="flot height-5" data-title="Panen" data-color="#9C27B0"></div>
                    </div>
                  </div><!--end .card-body -->
                </div><!--end .card -->
              </div>
