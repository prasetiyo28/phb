<div id="content">
  ...
  <div class="section-action" style="webkit-box-shadow: none; box-shadow: none;">
    ...
    <div class="section-floating-action-row">
      <?php if ($this->session->userdata('pekerjaan')==1) {
        $cbtn='btn-success';
      }elseif ($this->session->userdata('pekerjaan')==2) {
        $cbtn='btn-info';
      }else {
        $cbtn='btn-warning';
      } ?>
...
<?php $this->load->view('User/peta/modal_produksi'); ?>
      ...
      if (status === 'OK') {
        if (results[1]) {
          ...
          if (cari>0) {
            ...
            $("#form_peta").attr('action',"<?php echo base_url('User/update_peta_produksi'); ?>");
    ...
    if ($('#cb_pertanian_panen').is(':checked')) {
      if (get_mark1==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_pertanian_panen'); ?>"
          }
        ).done(function( data )
        {
    ...
    if ($('#cb_pertanian_belum').is(':checked')) {
      if (get_mark2==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_pertanian_belum'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_pertanian_gagal').is(':checked')) {
      if (get_mark3==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_pertanian_gagal'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_perikanan_panen').is(':checked')) {
      if (get_mark4==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_perikanan_panen'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_perikanan_belum').is(':checked')) {
      if (get_mark5==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_perikanan_belum'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_perikanan_gagal').is(':checked')) {
      if (get_mark6==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_perikanan_gagal'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_peternakan_panen').is(':checked')) {
      if (get_mark7==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_peternakan_panen'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_peternakan_belum').is(':checked')) {
      if (get_mark8==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_peternakan_belum'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_peternakan_gagal').is(':checked')) {
      if (get_mark9==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_peternakan_gagal'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_mydata_panen').is(':checked')) {
      if (get_mark_my_panen==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_mydata_panen'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_mydata_belum').is(':checked')) {
      if (get_mark_my_belum==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_mydata_belum'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
    ...
    if ($('#cb_mydata_gagal').is(':checked')) {
      if (get_mark_my_gagal==false) {
        $.ajax(
          {
            type: "GET",
            url: "<?php echo base_url('User/get_all_mydata_gagal'); ?>"
          }
        ).done(function( data )
        {
          var jsonObj = JSON.parse(data);
...
function deleteAct(id) {
  var data = new FormData();
    ...
    var url = "<?php echo base_url('User/deleteProduksi/'); ?>";
...
function edit(id) {
  ...
  $.ajax(
    {
      type: "GET",
      url: "<?php echo base_url('User/edit_produksi'); ?>/"+id,
    }
  ).done(function( data )
  {
...
function detail(id) {
  ...
  $.ajax(
    {
      type: "GET",
      url: "<?php echo base_url('User/detail_produksi'); ?>/"+id,
    }
  ).done(function( data )
  {
    $('#viewcanvas-kiri').html(data);
...
function profil(id) {
  ...
  $.ajax({
            ...
            processData: false,
            contentType: false,
            url:"<?php echo base_url('User/makesesion/') ?>",
            success: function(data)
            {
              if (data=='1') {
