  ...
  <div id="offcanvas-demo-left1" class="offcanvas-pane width-9" style="z-index:1000;">
    ...
    <div class="offcanvas-body">
      ...
      <hr style="margin-top: 0px;">
        ...
        <br>
        <form class=" form form-validate" id="form_update_produksi" novalidate="novalidate" method="post" action="<?php echo base_url() ?>/User/update_produksi">
                  ...
                  <div id="formgrup_icon1">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <label>Perkiraan Harga Perkilo/ekor</label>
                      </div>
                      <?php if ($a->bidang=='2'): ?>
                        <div class="form-group">
