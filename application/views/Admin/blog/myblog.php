                  ...
                  <div class="col-md-4">
                    <article>
                      <div class="card-body <?php echo $warna[0] ?> blog-text" style="height: 35em;">
                        ...
                        <h3><a class="link-default" href="<?php echo base_url('Admin/detail_post/'.$b->id_news) ?>"><?php echo $b->id_news ?> <?php echo $b->judul ?></a></h3>
                    ...
                    <div class="col-md-4">
                      <article>
                        ...
                        <div class="card-body blog-text <?php echo $warna[0] ?>" style="height: 35em;">
                          ...
                          <?php endif; ?> | <a href="#"><?php echo ttl_komentar($b->id_news) ?> komentar <i class="fa fa-comment-o"></i></a></div>
                          <h3><a class="link-default" href="<?php echo base_url('Admin/detail_post/'.$b->id_news) ?>"><?php echo $b->judul ?></a></h3>
                          <?php echo  substr($b->isi,0,270)  ?>...
                        </div>
                      </article><!-- end /article -->
                    </div>
      ...
      <div class="col-lg-offset-1 col-lg-3 col-md-2">
        <div class="card card-underline style-default-dark">
          ...
          <div class="card-body no-padding">
            <ul class="list">
              <li class="tile">
                <a href="<?php echo base_url('Admin/create_post') ?>" class="tile-content ink-reaction">
                  <div class="tile-icon">
              ...
              <li class="tile">
                <a href="<?php echo base_url('Admin/myblog') ?>" class="tile-content ink-reaction">
                  <div class="tile-icon">
        ...
        <div class="card card-underline style-default-bright">
          ...
          <div class="card-body no-padding">
            <ul class="list">
              <li class="tile">
                <a href="<?php echo base_url('Admin/blogtags/0') ?>" class="tile-content ink-reaction">
                  <div class="tile-icon">
                  </div>
                  <div class="tile-text">
              ...
              <li class="tile">
                <a href="<?php echo base_url('Admin/blogtags/1') ?>" class="tile-content ink-reaction">
                  <div class="tile-icon">
                  </div>
                  <div class="tile-text">
              ...
              <li class="tile">
                <a href="<?php echo base_url('Admin/blogtags/2') ?>" class="tile-content ink-reaction">
                  <div class="tile-icon">
                  </div>
                  <div class="tile-text">
              ...
              <li class="tile">
                <a href="<?php echo base_url('Admin/blogtags/3') ?>" class="tile-content ink-reaction">
                  <div class="tile-icon">
                  </div>
                  <div class="tile-text">
