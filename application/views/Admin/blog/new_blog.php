  ...
  <section class="has-actions style-default-bright">
    ...
    <div class="section-body">
      <div class="row row-centered">
        ...
        <div class="col-md-8">
          <h3>Compose</h3>
          <form class="form form-validate" novalidate="novalidate" id="formCompose" method="post" action="<?php echo base_url()?>Admin/simpan_blog" enctype="multipart/form-data">
            <div class="form-group floating-label">
              <input type="text" class="form-control" name="judul" required data-rule-badWords="true">
              <label>Judul</label>
            </div><!--end .form-group -->
            <div class="form-group">
              <textarea id="simple-summernote" name="isi" class="form-control control-6-rows" spellcheck="false" required data-rule-badWords="true"></textarea>
            </div><!--end .form-group -->
            <div class="form-group">
            ...
            <div class="form-group floating-label">
              <input type="text" class="form-control" name="pesan" required data-rule-badWords="true">
    ...
    <div class="section-action style-primary">
      <div class="section-action-row">
        <a class="btn ink-reaction btn-icon-toggle" href="<?php echo base_url('Admin/myblog'); ?>"><i class="fa fa-chevron-left"></i></a>
      </div>
...
<script type="text/javascript">
  ...
  $( "#formCompose" ).submit(function( event ) {
    if ($('#parm').val()=='') {
      $('#divImg').addClass('card card-outlined style-danger');
