  ...
  <section class="has-actions style-default-bright">
					...
					<div class="section-action style-primary">
						<div class="section-floating-action-row">
							<a class="btn ink-reaction btn-floating-action btn-lg btn-accent" href="<?php echo base_url('Admin/buat_email'); ?>" data-toggle="tooltip" data-placement="top" data-original-title="Compose">
								<i class="md md-add"></i>
							</a>
						</div>
...
function readEmail(id) {
  $.ajax(
    {
      type: "GET",
      url: "<?php echo base_url('Admin/readEmail/'); ?>"+id
    }
  ).done(function( data )
  {
    $('#readEmail').html(data);
