      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-3 col-lg-2">
          ...
          <ul class="nav nav-pills nav-stacked nav-icon">
            ...
            <li id="lik" class="active"><a  href="<?php echo base_url('Admin/sms') ?>"><span class="glyphicon glyphicon-inbox"></span>Kotak Keluar</a></li>
          </ul>
        </div><!--end . -->
        <!-- END INBOX NAV -->
...
<script type="text/javascript">
		...
		function kirim(url,jml,jml_kirim) { //url dari flashdata yang dikirim server php / function
                    ...
                    toastr.success("SMS berhasil dikirim.", '');
				          	window.location.href="<?php echo base_url('Admin/sms') ?>";
				          }
...
$(document).ready(function() {
  $('select').select2();
  $('.select2-search-choice-close').css("padding","unset");
...
function deleteAct(id) {
  ...
  $.ajax(
    {
      type: "POST",
      url: "<?php echo base_url('Admin/deleteSMS/'); ?>",
      data: data,
      processData: false,
      contentType: false,
      success: function(data)
...
function send_broadcast() {
  ...
  if(!valid) {
    ...
    $.ajax({
      ...
      processData: false,
      contentType: false,
      url: "<?php echo base_url('Admin/send_broadcast_sms')?>",
      success: function(data)
      {
