  ...
  <section class="has-actions style-default-bright">
    ...
    <div class="section-body">
      <div class="row row-centered">
        ...
        <div class="col-md-8">
          <h3>Compose</h3>
          <form class="form form-validate" novalidate="novalidate" id="formCompose" method="post" action="<?php echo base_url()?>Admin/send_mail" enctype="multipart/form-data">
    ...
    <div class="section-action style-primary">
      <div class="section-action-row">
        <a class="btn ink-reaction btn-icon-toggle" href="<?php echo base_url('Admin/email'); ?>"><i class="fa fa-chevron-left"></i></a>
      </div>
...
<!-- END CONTENT -->
<?php $this->load->view('Admin/canvas'); ?>
