      ...
      <div class="row">
        ...
        <div class="col-sm-4 col-md-3 col-lg-2">
          ...
          <ul class="nav nav-pills nav-stacked nav-icon">
            ...
            <li id="lic" class="active"><a  href="<?php echo base_url('Admin/chat') ?>"><span class="glyphicon glyphicon-inbox"></span>Chatting <small id="chatNotif"></small></a></li>
...
function send() {
  ...
  if(!valid) {
    ...
    $.ajax({
      ...
      processData: false,
      contentType: false,
      url: "<?php echo base_url('Admin/send_chat')?>",
...
function viewchat(room_id,id_chat) {
  $.ajax(
    {
      type: "GET",
      url: "<?php echo base_url('Admin/readChat/'); ?>"+room_id+"/"+id_chat
    }
  ).done(function( data )
  {
    $('#box_chat').html(data);
...
function deleteAct(room_id) {
  ...
  $.ajax(
    {
      type: "POST",
      url: "<?php echo base_url('Admin/deleteChat/'); ?>",
      data: data,
      processData: false,
      contentType: false,
