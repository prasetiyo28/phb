...
<div class="col-xs-12 col-lg-6 hbox-xs">
  <div class="hbox-column width-2">
    <img class="img-circle img-responsive pull-left" src="<?php echo base_url() ?>/assets/uploads/<?php echo $p->foto ?>" alt="Foto" style="height:80px;width:80px;" />
  </div><!--end .hbox-column -->
  <div class="hbox-column v-top">
    <div class="clearfix">
      <div class="col-lg-12 margin-bottom-lg">
        <a class="text-lg text-medium nama" onclick="profil('<?php echo $p->id_user ?>')" href="javascript:void(0)"><?php echo $p->nama ?></a>
      </div>
    </div>
    ...
    <div class="clearfix">
      <div class="col-lg-12">
        <span class="opacity-75"><span class="glyphicon glyphicon-map-marker text-sm"></span> &nbsp;<?php echo substr($p->alamat,0,40)."..." ?></span>
      </div>
    </div>
