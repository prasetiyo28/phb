<div id="modal_add_user2" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <form class="form form-validate" novalidate="novalidate" method="post" action="<?php echo base_url() ?>/Admin/insert_user">
				<div class="card">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <input type="text" class="form-control" name="telp" data-rule-duplicatPhoneUser="true" data-rule-duplicatPhoneAdmin="true" required>
            ...
            <div>
              <label class="radio-inline radio-styled">
                ...
                <?php elseif ($this->session->userdata('bidang')==2): ?>
                  <input type="radio" name="pekerjaan" value="2" checked><span>Petambak</span>
                <?php else: ?>
                  <input type="radio" name="pekerjaan" value="3" checked><span>Peternak</span>
                <?php endif; ?>
            </div>
